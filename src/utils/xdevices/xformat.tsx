...
// {xF.xTimeDateFormat(carMoveAllData?.serverTime, false)} // To show Unit
...
const textEventMapping = {
  ...
  const xTextEventMapping = "";
//   const xTextEventMapping = (text: string) : string => {
//     if (text in textEventMapping) {
//       return textEventMapping[text];
//     } else {
//       return text;
//     }
//   };
